...
// Generar 20 frentes con nombre "XX"
const datosFase3 = Array.from({ length: 20 }, (_, i) => ({
  id: i + 1,
  nombreCompleto: `Descripción detallada del frente ${i + 1}`,
  nombre: "XX",
  enlace: `?frente=${i + 1}`
}));
    ...
    <div style={containerStyle}>
      <div style={headerStyle}>
        <div style={phaseSelectorStyle}>
          ...
          <button style={phaseButtonStyle(true)} onClick={() => handleNavigate(3)}>Fase III</button>
          <button style={phaseButtonStyle(false)} onClick={() => handleNavigate(4)}>Fase IV</button>
        </div>
        <p style={subtitleStyle}>SELECCIÓN DE FRENTES DE TRABAJO (20 frentes)</p>
      </div>

      <div style={qrGridStyle}>
        {datosFase3.map((frente) => (
