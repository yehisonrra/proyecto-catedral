// src/pages/fases/Fase4.jsx
import React from 'react';
import { useNavigate } from 'react-router-dom';

// Generar 12 frentes con nombre "XX"
const datosFase4 = Array.from({ length: 12 }, (_, i) => ({
  id: i + 1,
  nombreCompleto: `Documentación y registro del frente ${i + 1}`,
  nombre: "XX",
  enlace: `?frente=${i + 1}`
}));
...
export default function Fase4() {
 ...
 const imagenFondo = '/logos/FONDO.jpg';
  const imagenGenerica = '/Fases/fase1/grua.png';   // Imagen provisional para todos los frentes
    ...
    <div style={containerStyle}>
      <div style={headerStyle}>
        <div style={phaseSelectorStyle}>
          ...
          <button style={phaseButtonStyle(true)} onClick={() => handleNavigate(4)}>Fase IV</button>
        </div>
        <p style={subtitleStyle}>SELECCIÓN DE FRENTES DE TRABAJO (12 frentes)</p>
      </div>

      <div style={qrGridStyle}>
        {datosFase4.map((frente) => (
