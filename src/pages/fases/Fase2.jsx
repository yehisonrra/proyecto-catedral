...
export const datosFase2 = [
  ...
  { id: 4, nombreCompleto: "Instalaciones eléctricas y seguridad - Pai (1era de tres fases).", nombre: "INSTALACIONES ELÉCTRICAS Y SEGURIDAD", imagen: "/logos/frente4.png" },
  { id: 5, nombreCompleto: "Consolidación de losas planas posteriores suroeste.", nombre: "LOSAS PLANAS - SUROESTE", imagen: "/logos/frente5.jpeg" },
  { id: 6, nombreCompleto: "Consolidación de fachada lat. suroeste.", nombre: "CONSOLIDACIÓN DE FACHADA SO", imagen: "/logos/frente6.png" },
  { id: 7, nombreCompleto: "Restauración de las fachadas desde losas planas a tejado de lateral noreste-suroeste y posterior.", nombre: "REST. DE LAS FACHADAS NE-SO Y POST", imagen: "/logos/frente7.jpeg" },
