...
const footerStyle = { 
  ...
  padding: '20px 30px', display: 'flex', alignItems: 'center', justifyContent: 'space-between',
  width: '100%', borderBottom: '6px solid #f37021', boxSizing: 'border-box',
  marginTop: 'auto' 
};
  const unefaLogoStyle = { height: '45px', width: 'auto', filter: 'drop-shadow(0px 2px 2px rgba(0,0,0,0.1))' };

  return (
    <footer style={footerStyle}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          <img src="/logos/LOGO_INCODACA.png" alt="INCODACA" style={{ height: '40px' }} />
          <div style={{ height: '30px', width: '1px', backgroundColor: 'rgba(0,0,0,0.1)' }}></div>
        ...
        <div style={{ textAlign: 'right', display: 'flex', alignItems: 'center', gap: '15px' }}>
          ...
          <img src="/logos/LOGO_UNEFA.png" alt="Logo UNEFA" style={unefaLogoStyle} />
        </div>
      </footer>
  );
}